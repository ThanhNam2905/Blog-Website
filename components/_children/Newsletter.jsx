    ...
    return (
        <section className="bg-gray-100">
            <div className="container mx-auto md:px-20 py-16 text-center">
                ...
                <div className="my-4">
                    <input type="text" className="w-full md:w-8/12 shadow-md border-2 border-gray-300 rounded-md p-3 text-gray-600 focus:outline-none focus:ring-1 focus:ring-gray-400" placeholder="Enter your email..." />  
                </div>
