        ...
        <div className="lg:container lg:mx-auto flex flex-col items-center text-center py-4 sm:flex-row sm:justify-between">
            ...
            <div className="w-96 order-3 flex justify-center">
                <div className="flex gap-x-6">
                    <Link href={"/"}>
                        <p><ImFacebook title="Facebook" className="text-[#888888] w-6 h-6 cursor-pointer"/></p>
                    </Link>
                    <Link href={"/"}>
                        <p><ImTwitter title="Twitter" className="text-[#888888] w-6 h-6 cursor-pointer"/></p>
                    </Link>
                    <Link href={"/"}>
                        <p><ImYoutube title="Youtube" className="text-[#888888] w-6 h-6 cursor-pointer"/></p>
                    </Link>
